...
public void I_open_automationpractice_website()throws Exception
{
	...
	System.setProperty("webdriver.chrome.driver","‪C:\\Shashi\\chromedriver.exe");
	...
	start_now.click();
	 ...
	 file=new FileInputStream("C:\\Shashi\\Vehicle details.xls");
		objwb=Workbook.getWorkbook(file);
		s1=objwb.getSheet(0);
		
		
	wwb = Workbook.createWorkbook(new FileOutputStream("C:\\Shashi\\Vehicle1.xls"));
    ws = wwb.createSheet("Vehicle",0);
     ...
     Thread.sleep(2000);
		...
		FileUtils.copyFile(scrfile, new File("C:\\Shashi\\Vehicle"+time+".png"));
